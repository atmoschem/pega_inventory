...
# 1.A.2.j - IPCC Wood and wood products
# 1.A.2.l - IPCC Textile and Leather
...
db[
  code == "1.A.2.l" &
    tech == "industrial boiler for flue tube & water tube type"
] -> dbf
...
fwrite(
  dt,
  "estimation/1/1.A/1.A.2/emissions/1A2l_IPCC_natural_gas.csv"
)
