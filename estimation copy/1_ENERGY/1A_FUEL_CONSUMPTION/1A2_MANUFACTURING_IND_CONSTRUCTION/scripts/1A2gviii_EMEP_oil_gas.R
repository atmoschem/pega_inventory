...
# [1] "Enamel"                                                                "Plaster (gysum) manufacture"
# [3] "Asphalt"                                                               "Glass (flat, container, domestic, special,cont. filament glass fibre)"
# [5] "Mineral Wool"
...
fwrite(
  dt,
  "estimation/1/1.A/1.A.2/emissions/1A2gviii_EMEP_oil_gas.csv"
)
