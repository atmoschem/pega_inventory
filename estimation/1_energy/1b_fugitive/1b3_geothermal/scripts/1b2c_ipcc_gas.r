...
db[
  code == "1.B.3" &
    tech ==
      "Geothermal systems can be considered as geochemical reservoirs of CO2. Degassing of mantle-derived magma is the sole source of CO2 in these systems in Iceland"
] -> db_ef
...
activity <- data.table(
  ...
  unit = "kMWh electricity produced",
...
fwrite(
  dt,
  "estimation/1/1.B/1.B.3/emissions/1B3_IPCC_gas.csv"
)
