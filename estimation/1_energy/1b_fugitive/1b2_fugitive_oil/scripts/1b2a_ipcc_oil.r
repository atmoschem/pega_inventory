...
db[
  code == "1.B.2.a" &
    tech ==
      "Normal operations: fugitive emissions; deliberate releases from pneumatic devices and process vents"
] -> db_ef
...
fwrite(
  dt,
  "estimation/1/1.B/1.B.2/emissions/1B2a_IPCC.csv"
)
# Biomass
# Gaseous Fuels
# Liquid Fuels
