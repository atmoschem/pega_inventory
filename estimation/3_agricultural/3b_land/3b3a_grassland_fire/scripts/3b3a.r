...
db[
  ...
  other == "Early dry season, low intensity fire. Vegetation: Open woodland with tussock grass understorey. EFs for combustion of fine fuels during passage of the fire front."
] -> db_ef
...
dt[, emissions := ef * activity] # need to change unit of ef from kg to g
# BC is % of PM2.5
# dt[pol == "PM2.5"]
# dt[pol == "BC"]
...
fwrite(
  dt,
  "estimation/3_agricultural/3b3/emissions/3b3a.csv"
)
