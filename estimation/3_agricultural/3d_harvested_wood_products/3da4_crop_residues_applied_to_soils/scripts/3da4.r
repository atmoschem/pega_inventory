...
#  "3.B.4.g.i - "Laying hens"
#  "3.B.4.g.Ii - more Broilers
#  "3.B.4.g.ii - "Broilers"
#  "3.B.4.g.iii - Turkeys"
#  "3.B.4.g.iv - other poultry
#  "3.B.4.g.iv - other
# "3.B.5 - Settlements\n"  
...
# "3.D.a.1 - "Manure applied to soils"  
# "3.D.a.2 - "Manure applied to soils"  
# "3.D.a.2.a - "Animal manure applied to soils"
# "3.D.a.2.b - "Sewage sludge  applied to soils"
# "3.D.a.3 - "Excreta deposited by grazing livestock"
# "3.D.a.3.a - "Urine and dung deposited by grazing animals"
...
db[
  code == codex
][unit == "kg NH3 kg-1 crop N residue N on soil surface for 3 days"][1] -> db_ef
...
activity <- data.table(
  ...
  unit = "kg-1 crop N residue N on soil surface for 3 days",
...
fwrite(
  dt,
  "estimation/3_agricultural/3d/emissions/3da4.csv"
)
