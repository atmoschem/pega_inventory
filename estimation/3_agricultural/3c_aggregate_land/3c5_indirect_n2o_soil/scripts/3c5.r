...
db[
  code == codex
][unit == "g N2O-N/kg N leaching/runoff"][1] -> db_ef
...
dt[, emissions := ef * 1000000 * activity] # need to change unit of ef from Mg to g
# BC is % of PM2.5
# dt[pol == "PM2.5"]
# dt[pol == "BC"]
...
fwrite(
  dt,
  "estimation/3_agricultural/3c/emissions/3c5.csv"
)
