...
db[
  code == "2.C.3" &
    table %in% c("Table_3-1",
  "2019 Refinement to the 2006 IPCC Guidelines for National Greenhouse Gas Inventories, Volume 3, Chapter 4, page 4.53"
) 
][c(1:12, 18)] -> db_ef
...
fwrite(
  dt,
  "estimation/2_industrial_processes/2c_iron_steel/2c3/emissions/2c3.csv"
)
