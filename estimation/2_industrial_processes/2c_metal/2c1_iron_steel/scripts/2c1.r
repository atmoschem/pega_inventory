...
db[
  code == "2.C.1" &
    table %in% c("Table_3-11",
  "Tichy, M. (1999). Personal communication with plant personnel, January 1999., IPCC Good Practice Guidance and Uncertainty Management in National Greenhouse Gas Inventories (Page 3.28)"
)
] -> db_ef
...
fwrite(
  dt,
  "estimation/2_industrial_processes/2b_iron_steel/2c1/emissions/2c1.csv"
)
