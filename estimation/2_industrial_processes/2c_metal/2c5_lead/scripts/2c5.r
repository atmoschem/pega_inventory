...
db[
  code == "2.C.5" &
    tech %in% c("Primary lead production",
  "Source and Furnace Type: Direct Smelting (DS) Production")
][is.na(region) | region != "EU-28"] -> db_ef
...
fwrite(
  dt,
  "estimation/2_industrial_processes/2c_iron_steel/2c5/emissions/2c5.csv"
)
